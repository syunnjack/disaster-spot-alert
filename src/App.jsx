...
const saveKey = 'disaster-spot-alert.saved'
const postKey = 'disaster-spot-alert.posts'
const alerts = [
  {
    "id": "disaster-spot-alert-1",
    "title": "避難 alert seed 1",
    "area": "名古屋",
    "category": "避難",
    "score": 95,
    "summary": "災害、悪天候、交通停止時に避難、営業中、充電、トイレ、宿泊スポットを通知する地域SaaS。 避難の条件一致時に通知し、保存、送客、課金へつなげます。",
    "channels": [
      "LINE",
      "X"
    ],
  ...
  {
    "id": "disaster-spot-alert-2",
    "title": "営業中 alert seed 2",
    "area": "東京",
    "category": "営業中",
    "score": 92,
    "summary": "災害、悪天候、交通停止時に避難、営業中、充電、トイレ、宿泊スポットを通知する地域SaaS。 営業中の条件一致時に通知し、保存、送客、課金へつなげます。",
    "channels": [
      "LINE",
      "X",
      "メール"
  ...
  {
    "id": "disaster-spot-alert-3",
    "title": "充電 alert seed 3",
    "area": "大阪",
    "category": "充電",
    "score": 89,
    "summary": "災害、悪天候、交通停止時に避難、営業中、充電、トイレ、宿泊スポットを通知する地域SaaS。 充電の条件一致時に通知し、保存、送客、課金へつなげます。",
    "channels": [
      "LINE",
      "X",
      "メール",
  ...
  {
    "id": "disaster-spot-alert-4",
    "title": "トイレ alert seed 4",
    "area": "静岡",
    "category": "トイレ",
    "score": 86,
    "summary": "災害、悪天候、交通停止時に避難、営業中、充電、トイレ、宿泊スポットを通知する地域SaaS。 トイレの条件一致時に通知し、保存、送客、課金へつなげます。",
    "channels": [
      "LINE",
      "X"
    ],
  ...
  return (
    <main className="app-shell">
      <section className="hero">
        <div>
          <p className="eyebrow">災害・悪天候時の避難/営業中スポット通知</p>
          <h1>Disaster Spot Alert</h1>
          <p className="lead">災害、悪天候、交通停止時に避難、営業中、充電、トイレ、宿泊スポットを通知する地域SaaS。</p>
        </div>
        <aside className="hero-panel">
          <span>disasterspot.jp / disaster-spot-alert</span>
